...
const initializeApp = () => {
    if (firebase_1.default.apps && firebase_1.default.apps.length > 0) {
        ...
        return firebase_1.default.initializeApp(firebaseConfig);
};
...
const verifySms = (id, code) => {
    const credential = firebase_1.default.auth.PhoneAuthProvider.credential(id, code);
    const signInResponse = firebase_1.default.auth().signInWithCredential(credential);
